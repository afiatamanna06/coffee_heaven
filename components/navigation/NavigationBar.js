...
function NavigationBar() {
  ...
  return (
    <Flex justify="space-between" px={["4", "4", "4", "28", "40"]} py={["4"]} backdropFilter="blur(8px)" alignItems={["start", "start", "start", "center", "center"]} bg={["rgba(190, 156, 121, .15)"]} border="1px" borderColor="rgb(69, 51, 33)" position="fixed" zIndex={99} w="full" h={responsiveDisplay === "flex" ? ["100vh", "100vh", "100vh", "min-content", "min-content"] : "min-content"} direction={["column", "column", "column", "row", "row"]}>
