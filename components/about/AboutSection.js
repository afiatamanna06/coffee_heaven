  ...
  return (
    <Box as={Center} id="About" py="20">
        <Grid templateColumns={["repeat(1, 1fr)", "repeat(1, 1fr)", "repeat(1, 1fr)", "repeat(2, 1fr)", "repeat(2, 1fr)"]} alignItems="center" maxW="80rem" columnGap={["20"]} rowGap={["8"]}>
            ...
            <Flex direction="column" alignItems={["center", "center", "center", "start", "start"]}>
                <Heading mb="2" textAlign={["center", "center", "center", "start", "start"]} fontFamily="'Merienda One', cursive" color={["white", "white", "white", "#333", "#333"]} fontSize="6xl">A Cup Of Coffee Can Complete Your Day</Heading>
                <Box mb="4" textAlign={["center", "center", "center", "start", "start"]} fontSize="lg" color={["white", "white", "white", "#333", "#333"]}>Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veniam Suscipit Sunt Repellendus, Dolorum Recusandae Placeat Quae. Iste Eaque Aspernatur, Animi Deleniti Voluptas, Sunt Molestias Eveniet Sint Consectetur Facere A Ex.</Box>
